...
export const translations = {
  fr: {
    ...
    promoCode: "Code d'accès VIP",
    promoCodePlaceholder: "Entrez votre clé secrète",
    startFreeTrial: "Essai gratuit",
    tagline: "Prédisez votre progrès avec l'IA de précision",
    landingTitle: "Votre Santé Compte. *Rendez-la Facile.*",
    ...
    errorVIP: "Code promo secret invalide ou manquant. Accès réservé aux VIP.",
  ...
  en: {
    ...
    promoCode: "VIP Access Key",
    promoCodePlaceholder: "Enter secret key",
    startFreeTrial: "Start Free Trial",
    tagline: "Predict Your Progress with Precision AI",
    landingTitle: "Your Health Counts. *Make It Easy.*",
    ...
    errorVIP: "Invalid or missing secret promo code. Access restricted to VIPs only.",
